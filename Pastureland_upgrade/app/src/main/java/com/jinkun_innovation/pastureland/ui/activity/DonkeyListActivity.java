...
public class DonkeyListActivity extends AppCompatActivity {

    private static final String TAG1 = DonkeyListActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donkey_list);
...
//            viewHolder.mTextView.setText(datas[position]);
            ...
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    ...
                    //删除第 position 条目
                    new SweetAlertDialog(DonkeyListActivity.this, SweetAlertDialog.WARNING_TYPE)
                            .setTitleText("删除?")
            ...
            if (variety.equals("801")) {
                viewHolder.tvYangName.setText("品种：驴");
            } else {
