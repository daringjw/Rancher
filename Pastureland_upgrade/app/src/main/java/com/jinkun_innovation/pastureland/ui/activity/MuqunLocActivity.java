...
//        mText.setText(messageEvent.getMessage());
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBdLocation.setLongitude(Double.parseDouble("116.397428"));
        mBdLocation.setLatitude(Double.parseDouble("39.86923"));
...
//        button.setBackgroundResource(R.mipmap.popup);
        mButton.setText("牲畜类型：羊\n" + "牲畜品种：乌珠穆泣黑头羊\n" + "   设备编号：1234567891023456   \n"
                + "   上传时间：2018-04-25 09:02:01   \n" + "牲畜位置：北京海淀区五道口路");

//定义用于显示该InfoWindow的坐标点

        mPt = new LatLng(39.86923, 116.397428);
